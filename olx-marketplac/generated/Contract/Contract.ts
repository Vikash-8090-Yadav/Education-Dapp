...
export class ChaiBought extends ethereum.Event {
  get params(): ChaiBought__Params {
    return new ChaiBought__Params(this);
  }
}

export class ChaiBought__Params {
  _event: ChaiBought;

  constructor(event: ChaiBought) {
    this._event = event;
  }
...
export class TokenResold extends ethereum.Event {
  get params(): TokenResold__Params {
    return new TokenResold__Params(this);
  }
}

export class TokenResold__Params {
  _event: TokenResold;

  constructor(event: TokenResold) {
    this._event = event;
  }
...
export class Contract__fetchItemsListedResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
...
export class Contract__fetchMarketItemsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__fetchMyNFTsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract extends ethereum.SmartContract {
  ...
  fetchItemsListed(): Array<Contract__fetchItemsListedResultValue0Struct> {
    ...
    return result[0].toTupleArray<
      Contract__fetchItemsListedResultValue0Struct
    >();
  }

  try_fetchItemsListed(): ethereum.CallResult<
    Array<Contract__fetchItemsListedResultValue0Struct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Contract__fetchItemsListedResultValue0Struct>()
    );
  }

  fetchMarketItems(): Array<Contract__fetchMarketItemsResultValue0Struct> {
    let result = super.call(
      "fetchMarketItems",
    ...
    return result[0].toTupleArray<
      Contract__fetchMarketItemsResultValue0Struct
    >();
  }

  try_fetchMarketItems(): ethereum.CallResult<
    Array<Contract__fetchMarketItemsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMarketItems",
      "fetchMarketItems():((uint256,address,address,uint256,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Contract__fetchMarketItemsResultValue0Struct>()
    );
  }

  fetchMyNFTs(): Array<Contract__fetchMyNFTsResultValue0Struct> {
    let result = super.call(
      "fetchMyNFTs",
    ...
    return result[0].toTupleArray<Contract__fetchMyNFTsResultValue0Struct>();
  }

  try_fetchMyNFTs(): ethereum.CallResult<
    Array<Contract__fetchMyNFTsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMyNFTs",
      "fetchMyNFTs():((uint256,address,address,uint256,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Contract__fetchMyNFTsResultValue0Struct>()
    );
  }
